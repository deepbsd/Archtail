...
lv_create(){
    ...
    root_dev=$(whiptail --title "Get Physical Volume Device" --radiolist "What partition for your Physical Volume Group?  (sda2, nvme0n1p2, sdb2, etc)" 20 50 10\ 
    "${choices[0]}" "" OFF \
    "${choices[1]}" "" ON \
    "${choices[2]}" "" OFF \
...
diskmenu(){
    ...
    while true ; do
        ...
        "M"   "Manually Partition Disk with cfdisk (experimental)"   \
